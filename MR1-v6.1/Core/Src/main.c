...
/**
  *****************************************************************************
	...
	*修改人                ：Robocon
	*****************************************************************************
	*1.本代码基于STM32F427IIH6，编译环境为Keil 5，基于FreeRTOS进行开发
	*2.本代码适用于Robocon 2019MR1机器人
	*3.本代码以UTF-8格式编码，请勿以ANST编码形式打开
	*4.本代码还有未完善的地方
...
/* USER CODE BEGIN PFP */
//extern uint8_t GyroReceiveData; /*陀螺仪接收数据*/
/* USER CODE END PFP */
...
//	HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_2);       //PWM2,用于控制机械组的电机（没写）
  ...
  HAL_UART_Receive_DMA(&huart1, UsartReceiveRemote, 18u);              //开启遥控器数据接收串口1
	...
	CanFilterInit(&hcan2);          //初始化CAN2过滤器
  /* USER CODE END 2 */
